...
#include "fi/rounding/NearOdd.hpp"
...
BOOST_AUTO_TEST_CASE( overflow_fl ) {
	...
	BOOST_CHECK_THROW( fic(3.9375),  Fi::PositiveOverflow );
	BOOST_CHECK_THROW( fic(3.94),    Fi::PositiveOverflow );
...
BOOST_AUTO_TEST_SUITE( nearodd_signed )

BOOST_AUTO_TEST_CASE( s_no_overflow_fl )
{

	typedef Fi::Fixed<4, 2, Fi::SIGNED, Fi::Throw, Fi::NearOdd> fic;
...
BOOST_AUTO_TEST_CASE( s_overflow_fl ) {
	...
	BOOST_CHECK_THROW( fic(1.9375),    Fi::PositiveOverflow );
	BOOST_CHECK_THROW( fic(16.0   ),   Fi::PositiveOverflow );
	BOOST_CHECK_THROW( fic(1e20   ),   Fi::PositiveOverflow );

	BOOST_CHECK_THROW( fic(-2.1250),   Fi::NegativeOverflow );
