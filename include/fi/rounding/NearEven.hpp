...
#ifndef FI_ROUNDING_NEAREVEN_HPP
#define FI_ROUNDING_NEAREVEN_HPP
...
namespace Fi {
	 ...
	 *which are settled towards the nearest even value.
...
#include "fi/private/rounding/NearEven.hpp"
